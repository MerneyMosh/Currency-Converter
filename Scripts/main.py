...
def convert():
    ...
    result_label['text'] = f'{to_currency} {converted_amount:.2f}'.upper()
...
#Result Output
result_label = Label(main_frame, text=" ", width=15, height=2, pady=7, padx=0, anchor=CENTER, font=('Ivy 16 bold'), bg=WHITE_COLOR, fg=BLACK_COLOR, relief=GROOVE)
result_label.place(x=50, y=10)


#From drop-downcurrency input selection 
...
#To drop-downcurrency input selection 
...
#Section for Amount to be converted
amount_entry = Entry(main_frame, width=22, justify=CENTER,font=('Ivy 12 bold'), relief=SOLID)
amount_entry.place(x=50, y=155)

#the convert Button
convert_button = Button(main_frame, text="Convert", width=19, padx=5, height=1, bg=BLUE_COLOR, fg=WHITE_COLOR, font=('Ivy 12 bold'), command=convert)
